...
#for (dd in 1:4){
  ...
  for(ff in 1:length(filelist)){
    ...
    url_sel <- paste0(site_url,dirlist[dd],"/",filelist[ff])
    ...
    print(paste0("Downloaded file ", ff, " of ", length(filelist), " from folder ",dd," of ",length(dirlist)))
  }
}
